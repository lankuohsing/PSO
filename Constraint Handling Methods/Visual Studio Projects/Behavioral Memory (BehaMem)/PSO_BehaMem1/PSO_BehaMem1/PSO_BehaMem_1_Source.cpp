#include <iostream>
#include "PSO_BehaMem_1_Header.h"
using namespace std;
int main(int argc, char* argv[])
{
	...
	PSOData = fopen("PSO_BehaMem1.dat","w+");//clear the file and write new data in  
	if (PSOData == NULL)
	{
	...
	EXCELData = fopen("PSO_BehaMem1_EXCEL.dat","w+");//clear the file and write new data in  
	if (PSOData == NULL)
	{
		printf("The file is not exit!\n");
		exit(1);
