...
#define PSO_popsize 500 //粒子个数                    
#define PSO_maxgen 100
#define Vmax 25 //速度极值，如果取值过大，不利于个体的优化,一般是upbound-lowbound
...
void ParticleSwarm::init(){
	...
	lowBound[0]=-1000,upperBound[0]=1000;
	lowBound[1]=-1000,upperBound[1]=1000;
