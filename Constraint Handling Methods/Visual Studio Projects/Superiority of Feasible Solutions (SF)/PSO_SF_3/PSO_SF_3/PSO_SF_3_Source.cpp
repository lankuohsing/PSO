...
int main(int argc, char* argv[])
{
	...
	PSOData = fopen("PSO_SF_2.dat","w+");//to clear the file and write into new data。 
	if (PSOData == NULL)
	{
	...
	PSO_EXCEL = fopen("PSO_SF_2_EXCEL.dat","w+");//to clear the file and write into new data。 
	if (PSO_EXCEL == NULL)
	{
